...
from vamos_functions import analyse, get_thumbnail, apply_defaults, set_defaults, delete_defaults, \
    write_vamos_file
...
class AnalysationWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.vamos_title_image.setGeometry(10, 0, 400, 105)
        self.vamos_title_image.setPixmap(QPixmap("files/vamos_logo_white.png"))
    ...
    def save_vamos_file(self):
        ...
        vamos_filepath = QFileDialog.getSaveFileName(self,
                                                     ...
                                                     "VAMOS Files (*.vamos)")[0]
        if vamos_filepath != "":
            write_vamos_file(Window.Fps, vamos_filepath, self.meteor_data, self.sort_out_list, self.len_mul,
